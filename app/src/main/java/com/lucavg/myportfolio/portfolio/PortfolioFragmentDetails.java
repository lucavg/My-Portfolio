...
public class PortfolioFragmentDetails extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String link = "<a href=\"https://drive.google.com/file/d/1UQ2jwZ8Abbofcwj0-i9fGdH-WKtN2OmD/view?usp=sharing\">SAP manual</a>";
        description.setText(Html.fromHtml(link, Html.FROM_HTML_MODE_COMPACT));
